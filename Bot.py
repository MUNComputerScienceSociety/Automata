...
bot = commands.Bot(command_prefix="!", help_command=None, intents=intents, description="A custom, multi-purpose moderation bot for the MUN Computer Science Society Discord server.")
